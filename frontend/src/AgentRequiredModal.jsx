...
const AGENT_DOWNLOAD_URL = 'https://github.com/Mansirathor4/employeetracking/releases/download/v1.0.0/PeopleConnect.HR.Agent.Setup.1.0.0.exe'; // Secure GitHub release link
